 ...
 *  - qurt_f.c:95:6: warning: explicitly assigning a variable of type 'double' to itself: fixed
 *  - qurt_f.c:105:6: warning: unused variable 'flag' [-Wunused-variable]: fixed
 */
...
**     
**    III-7. qurt_f.c : the root computation of a quadratic equation
